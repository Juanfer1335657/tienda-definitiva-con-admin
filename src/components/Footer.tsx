...
export default function Footer() {
  return (
    <footer style={{ backgroundColor: 'var(--bg-secondary)', padding: '48px 24px', marginTop: 64, boxShadow: 'var(--shadow-sm)' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 32 }}>
        ...
        <div>
          <h4 style={{ fontSize: 14, fontWeight: 600, color: 'var(--text-primary)', marginBottom: 16, textTransform: 'uppercase' }}>
            Contacto
          </h4>
          <p style={{ color: 'var(--text-secondary)', marginBottom: 8 }}>WhatsApp: +57 3015851969</p>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <a href="#" style={{ color: 'var(--text-secondary)', textDecoration: 'none' }}>Términos y condiciones</a>
            <a href="#" style={{ color: 'var(--text-secondary)', textDecoration: 'none' }}>Política de privacidad</a>
            <a href="#" style={{ color: 'var(--text-secondary)', textDecoration: 'none' }}>Envíos</a>
          </div>
        </div>
        <div>
          <h4 style={{ fontSize: 14, fontWeight: 600, color: 'var(--text-primary)', marginBottom: 16, textTransform: 'uppercase' }}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            ...
            <a href="https://wa.me/573015851969" style={{ color: 'var(--text-secondary)', textDecoration: 'none' }}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', paddingTop: 32, marginTop: 32, borderTop: '1px solid #eee', textAlign: 'center' }}>
        <p style={{ color: 'var(--text-secondary)', fontSize: 14 }}>© 2024 Hypertecnologian. Todos los derechos reservados.</p>
      </div>
    </footer>
  );
}